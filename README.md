...
- [x] (3 pts) **Add and implement Bottom Navigation to your application**
  ...
  - ![GIF showing Bottom Navigation functionality](https://i.imgur.com/bP6nSAR.gif) <!-- Replace this link with your actual image/GIF link -->
...
- [x] (4 pts) **Dynamically use fragments within Activities**
  ...
  - ![GIF showing fragment management](https://i.imgur.com/bP6nSAR.gif) <!-- Replace this link with your actual image/GIF link -->

- [x] (3 pts) **Customize the toolbar and icons**
  - Provides a unique toolbar experience for each section with relevant icons.
  - ![GIF showing toolbar customization](https://i.imgur.com/BdPOQQM.png) <!-- Replace this link with your actual image/GIF link -->
...
Airplane mode. <!-- Replace this with your specific challenges and experiences -->
